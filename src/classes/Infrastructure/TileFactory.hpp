...
public:
    ...
    std::shared_ptr<DynamicTile> createDynamicTile(sf::Uint32 x, sf::Uint32 y, std::unique_ptr<Grid>& grid);
    std::shared_ptr<StaticTile> createStaticTile(sf::Uint32 x, sf::Uint32 y, std::unique_ptr<Grid>& grid);
